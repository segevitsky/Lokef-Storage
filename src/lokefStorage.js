...
const LokefStorage = {
        ...
        return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                getAllRequest.onerror = () => {
                    reject(new Error('Error getting all items from store'));
                };
            }
            catch (error) {
                reject(error);
    ...
    getRangeData: (lowerRange, upperRange) => __awaiter(void 0, void 0, void 0, function* () {
        return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                const db = yield openDatabase();
                const transaction = db.transaction(['items'], 'readonly');
                const store = transaction.objectStore('items');
                const range = IDBKeyRange.bound(lowerRange, upperRange, false, true);
                const rangeRequest = store.getAll(range);
                rangeRequest.onsuccess = () => {
                    resolve(rangeRequest.result);
                };
                rangeRequest.onerror = () => {
                    reject(new Error('Error getting range data from store'));
                };
            }
            catch (error) {
                reject(error);
